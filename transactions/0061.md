...
[Compound Merkle Path Showcase]([https://dorzepowski.github.io/compound-merkle-path-viewer/](https://bitcoin-sv.github.io/showcase-merkle-paths/)) can help form an understanding of how CMP works to encode all necessary data.
