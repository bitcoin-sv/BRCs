...
### Chronicle Retrograde Op-code Restoration

11. Op-codes being restored in Chronicles are as follows:
- OP_VER (0x62) DISABLED
- OP_VERIF (0x65) DISABLED
- OP_VERNOTIF (0x66) DISABLED
- OP_SUBSTR (0x??) OVERWRITTEN
- OP_LEFT (0x??) OVERWRITTEN
- OP_RIGHT (0x??) OVERWRITTEN
