...
An application where users exchange messages with specific counterparties. This declares `counterpartyPermissions` so the wallet will prompt the user to establish trust (PACT) when a new counterparty is encountered. For example, the app might interact with counterparty `02aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa`:
  ...
  "properties": {
    ...
    "groupPermissions": {
      ...
      "properties": {
        ...
        "protocolPermissions": {
          "type": "array",
          "description": "Protocol access requests. Level 2 entries require `counterparty` and are scoped per originator + counterparty. Level 1 entries are application-scoped and may omit `counterparty`.",
          "items": {
            "type": "object",
            "properties": {
              "protocolID": {
              ...
              "counterparty": {
                ...
                "description": "Counterparty scope. Must be 'self', 'anyone', or a compressed public key. Required when `protocolID[0]` is 2. Empty string is invalid."
              },
              "description": {
                "type": "string",
