...
- The shared secret is then used to generate a scalar through HMAC [BRC-56](../wallet/0056.md) and convert it to a point on the elliptic curve.
...
- **HMAC Operations**: `createHmac` and `verifyHmac` allow for the creation and verification of Hash-based Message Authentication Codes (HMAC) to ensure data integrity as per [BRC-56](../wallet/0056.md).
