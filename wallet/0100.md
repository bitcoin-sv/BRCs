...
/**
 * @typedef {string & { minLength: 5, maxLength: 400 }} BasketString5to400Characters
 * A string for naming baskets, with a length between 5 and 400 characters.
 * @remarks
 * TypeScript cannot enforce length constraints. Validate at runtime for length compliance.
 */
export type BasketString5to400Characters = string

/**
 * @typedef {string & { minLength: 5, maxLength: 400 }} OutputTagString5to400Characters
 * A string for tagging outputs, with a length between 5 and 400 characters.
 * @remarks
 * TypeScript cannot enforce length constraints. Validate at runtime for length compliance.
 */
export type OutputTagString5to400Characters = string

/**
 * @typedef {string & { minLength: 5, maxLength: 400 }} LabelString5to400Characters
 * A string for labeling transactions, with a length between 5 and 400 characters.
 * @remarks
 * TypeScript cannot enforce length constraints. Validate at runtime for length compliance.
 */
export type LabelString5to400Characters = string
...
export interface Wallet {
   ...
   * @param {BasketString5to400Characters} [args.outputs[].basket] - Name of the basket where this UTXO will be held, if tracking is desired.
   ...
   * @param {OutputTagString5to400Characters[]} [args.outputs[].tags] - Tags assigned to the output for sorting or filtering.
   ...
   * @param {LabelString5to400Characters[]} [args.labels] - Optional labels providing additional categorization for the transaction.
  ...
  createAction: (
    args: {
      ...
      outputs?: Array<{
        ...
        basket?: BasketString5to400Characters
        customInstructions?: string
        tags?: OutputTagString5to400Characters[]
      }>
      lockTime?: PositiveIntegerOrZero
      version?: PositiveIntegerOrZero
      labels?: LabelString5to400Characters[]
      options?: {
   ...
   * @param {LabelString5to400Characters[]} args.labels - An array of labels used to filter actions.
   ...
   * @param {BasketString5to400Characters} args.outputs[].insertionRemittance.basket - Basket in which to place the output (for insertions).
   ...
   * @param {OutputTagString5to400Characters[]} [args.outputs[].insertionRemittance.tags] - Tags attached to the output (for insertions).
   * @param {DescriptionString5to50Characters} args.description - Human-readable description of the transaction being internalized.
   * @param {LabelString5to400Characters[]} [args.labels] - Optional labels associated with this transaction.
   * @param {BooleanDefaultTrue} [args.seekPermission] — Whether to seek permission from the user for this operation if required. Default true, will return an error rather than proceed if set to false.
   * @param {OriginatorDomainNameString} [originator] - Fully-qualified domain name (FQDN) of the application that originated the request.
   ...
   * @param {BasketString5to400Characters} args.basket - The associated basket name whose outputs should be listed.
   * @param {OutputTagString5to400Characters[]} [args.tags] - Filter outputs based on these tags.
   ...
   * @param {BasketString5to400Characters} args.basket - The associated basket name where the output should be removed.
