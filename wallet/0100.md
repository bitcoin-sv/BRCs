...
- Must not start with `p ` (allows for future "specially permissioned" protocols, not contemplated by this specification, see [BRC-98](../wallet/0098.md))
...
- Must not start with `p ` (allows for future "specially permissioned" baskets, not contemplated by this specification, see [BRC-99](../wallet/0099.md))
